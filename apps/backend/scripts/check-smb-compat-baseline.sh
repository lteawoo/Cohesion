...
# Dialect bounds + rollout deny taxonomy + rollback regression baseline
go test ./pkg/smbcore -run 'TestHandleConn_EnforcesDialectBoundsAndRejectsSMB1|TestHandleConn_ReadonlyPhaseDenied_EmitsTelemetryReason|TestHandleConn_RollbackToReadonly_DeniesNewWriteRequests'
