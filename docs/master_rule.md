...
3. 수정 완료 후 반드시 테스트
4. **연동된 tool playwright mcp**로 브라우저 직접 테스트한다.
5. playwright는 격리모드로 세팅되어 있으니 테스트가 완료되면 브라우저를 종료
6. 스크린샷을 이용하여 ui를 직접 보고 디자인 적합성을 판단. 스크린샷과 로그는 .playwright-mcp 폴더 안에 기록
